...
{
    /// <summary>
    /// Phase 5 (email): real password-reset flow. Mirror of
    /// AddEmailConfirmationTokens — same shape, shorter TTL (30 min)
    /// because a leaked reset link gives full account takeover.
    /// </summary>
    [DbContext(typeof(AltheaDbContext))]
    [Migration("20260520180000_AddPasswordResetTokens")]
